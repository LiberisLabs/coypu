...
namespace Coypu.Drivers.Tests
{
    internal class When_using_iframes_as_scope : DriverSpecs
    {
        ...
        private static void Finds_elements_among_multiple_scopes(ElementFinder elementFinder1, ElementFinder elementFinder2)
        {
            ...
            Assert.That(Button("scoped button", iframeOne, DefaultOptions).Id, Is.EqualTo("iframe1ButtonId"));
            Assert.That(Button("scoped button", iframeTwo, DefaultOptions).Id, Is.EqualTo("iframe2ButtonId"));
        }
        ...
        public void Finds_clear_scope_back_to_the_whole_window()
        {
            ...
            Assert.That(Button("scoped button", Root, Options.PreferExact).Id, Is.EqualTo("scope1ButtonId"));
        }
        ...
        public void Can_scope_around_an_iframe()
        {
            ...
            Assert.That(Button("scoped button", body, Options.PreferExact).Id, Is.EqualTo("scope1ButtonId"));
        }
