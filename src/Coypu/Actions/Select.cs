...
namespace Coypu.Actions
{
    internal class Select : DriverAction
    {
        ...
        internal Select(Driver driver, DriverScope scope, string locator, string optionToSelect, IDisambiguationStrategy disambiguationStrategy, Options options)
        ...
        internal Select(Driver driver, ElementScope selectElement, string optionToSelect, IDisambiguationStrategy disambiguationStrategy, Options options)
